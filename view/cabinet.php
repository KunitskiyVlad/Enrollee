		...
		<div class="row">
			<div class="cabinet">
				<form class="form-group">
					...
					<input type="text" name="name" class="form-control " id='name' readonly value=<?=$date['name']?> >
					...
					<input type="text" name="surname" class="form-control" id='surname' readonly value=<?=$date['surname']?>>
					...
					<input type="number" name="mark" min = '300' max ='700' class="form-control" id='mark' readonly value=<?=$date['mark']?>>
					<div class="checkbox form-check-inline">
  					<input type="checkbox" value="selecte">Изменить
					</div>
					...
					<input type="date" name="birth" class="form-control" id ='birth' readonly value=<?=$date['birth']?>>
					<div class="checkbox form-check-inline">
  					<input type="checkbox" value="selecte">Изменить
					</div>
